    ...
    string? Notice)
{
    ...
    public static readonly IReadOnlyList<string> DefaultPreference = ["beta", "stable", "unstable"];
    ...
    {
        var best = DefaultPreference.FirstOrDefault(c => releases.GetValueOrDefault(c) is not null);
